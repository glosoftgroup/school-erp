...
urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="parent/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="parent/form.html"), name='add'),
    url(r'^update/(?P<pk>[0-9]+)/$',
        UpdateView.as_view(template_name="parent/form.html", model=Table, fields=['id', 'first_name']),
        name='update'),
]
