...
urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="term/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="term/form.html"), name='add'),
    url(r'^update/(?P<pk>[0-9]+)/$',
        UpdateView.as_view(template_name="term/form.html", model=Table, fields=['id', 'name']),
        name='update'),
]
