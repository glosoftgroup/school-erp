...
from .models import Curriculum as Table


urlpatterns = [
    url(r'^$', permission_required('curriculum.view_curriculum', login_url='core:not_found')(TemplateView.as_view(template_name="curriculum/list.html")), name="index"),
