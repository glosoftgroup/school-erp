...
urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="stream/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="stream/form.html"), name='add'),
    url(r'^update/(?P<pk>[0-9]+)/$', TemplateView.as_view(template_name="stream/form.html"), name='update'),
]
