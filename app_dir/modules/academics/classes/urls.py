...
urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="class/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="class/form.html"), name='add'),
    url(r'^update/(?P<pk>[0-9]+)/$', TemplateView.as_view(template_name="class/form.html"), name='update'),
]
