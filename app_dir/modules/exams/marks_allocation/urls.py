...
urlpatterns = [
    ...
    url(r'^api/subjects/list/$', SubjectListView.as_view(), name='api-subject-list'),
    url(r'^api/exams/list/$', ExamListView.as_view(), name='api-exam-list'),
    url(r'^api/students/list/$', StudentListView.as_view(), name='api-student-list'),
