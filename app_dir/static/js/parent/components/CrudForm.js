       ...
       <div className="col-md-6">            
                ...
                <div className="form-group">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            <label className="text-bold">Email:<span className="text-danger">*</span></label>
                            <input value={this.state.email} onChange={this.handleInputChange} required className="form-control" name="email" id="email" placeholder="email@example.com" type="text"/>
                            <span className="help-block text-warning"></span>
                        </div>
                    </div>
                </div>
